...
define gui.interface_text_color = u'#bbbbbb'


## Polices et tailles de police ################################################

## Les polices utilisées pour le texte du jeu.
define gui.text_font = "fonts/Skranji-Regular.ttf"

## Les polices utilisées pour le nom des personnages.
define gui.name_text_font = "fonts/Skranji-Bold.ttf"

## Les polices utilisées pour les textes « hors du jeu ».
define gui.interface_text_font = "fonts/Skranji-Regular.ttf"
...
define gui.main_menu_background = Movie(play="gamemenu.webm")
...
define gui.choice_button_text_hover_color = "#111111"
